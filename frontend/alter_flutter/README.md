...
A faithful Flutter port of the Alter design prototype (UI + navigation, mock data).

> **Note:** This is a UI/navigation handoff codebase. It was authored from the approved
> HTML design prototype. Run it in your own Flutter toolchain to preview on a device/simulator.
